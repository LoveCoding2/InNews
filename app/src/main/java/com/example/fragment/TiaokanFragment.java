...
public class TiaokanFragment extends Fragment 
{
private ListView listView1;
    ...
    private String urlString="https://route.showapi.com/990-2?id=10&showapi_appid=15867&showapi_sign=0a84571c00634b9588ed1f8b8ff7c51a&page=";
           ...
           Bundle savedInstanceState)
   {
	 super.onCreateView(inflater,container,savedInstanceState);
	     ...
	     if (view==null) 
			{
		      view=inflater.inflate(R.layout.tiaokan,container,false);
			}	 
...
public void onActivityCreated(Bundle savedInstanceState) {
	...
	super.onActivityCreated(savedInstanceState);
	   ...
	   listView1=(ListView)getActivity().findViewById(R.id.tiaokan);
